...
urlpatterns = [
    ...
    path('service/orders/', views.OrderHeaderList.as_view()),
    #path('service/order/<int:pk>/', views.OrderHeaderDetail.as_view()),
    path('service/order/items/', views.OrderItemList.as_view()),
